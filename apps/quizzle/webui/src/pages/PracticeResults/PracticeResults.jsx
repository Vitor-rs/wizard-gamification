...
export const PracticeResults = () => {
        ...
        if (question.type === QUESTION_TYPES.TEXT) {
            ...
            return (
                <div className="sequence-answer">
                    <div className="answer-line">
                        ...
                        <div className="sequence-list">
                            {userOrder.map((originalIndex, position) => {
                                const answerContent = question.answers[originalIndex]?.content || `Resposta ${originalIndex + 1}`;
                    ...
                    {result !== 'correct' && (
                        <div className="answer-line">
                            <span className="answer-label">Ordem Correta:</span>
        ...
        return (
            <div className="practice-results-page">
                <div className="page-header">
                    ...
                    <div className="code-display">Código: <strong>{code}</strong></div>
                </div>
                <motion.div className="auth-card" initial={{opacity: 0, y: 20}} animate={{opacity: 1, y: 0}}>
                    <Button text="Voltar à Página Inicial" onClick={() => navigate('/')} />
                </motion.div>
            </div>
        );
    }
    ...
    const viewTabs = [
        ...
        {id: 'students', title: 'Detalhes', icon: faUser}
    ];
    ...
    return (
        <div className="practice-results-page">
            <div className="page-header">
                <img src={titleImg} alt="logo" className="logo"/>
                <h1>Resultados do Quiz de Treino</h1>
                <div className="code-display">Código: <strong>{code}</strong></div>
            </div>
                ...
                <div className="stats-overview">
                    ...
                    <div className="stat-card">
                        <div className="stat-number">
                            {formatDuration(results.meta.created, results.meta.expiry)} Dias
                        </div>
                ...
                title={
                    selectedStudent && (
                        <div className="student-details-title">
                            ...
                            Visão detalhada: {selectedStudent.name}
                        </div>
                    )
                }
