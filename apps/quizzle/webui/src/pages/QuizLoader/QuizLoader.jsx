...
export const QuizLoader = () => {
    ...
    const loadQuiz = async () => {
        ...
        if (!res){
            toast.error(`ID do Quiz não encontrado. Verifique se digitou o ID correto e se o quiz existe nesta instância.`);
            return;
        }
        ...
        <div className="loader-page" onDrop={onDrop} onDragOver={(e) => {e.preventDefault();
            ...
            <div className="quiz-loader">
                ...
                <div className="code-input">
                    <Input placeholder="ID do Quiz (ex: JWTIOI)" value={quizId} onChange={(e) => setQuizId(e.target.value)}/>
                ...
                <Button icon={faFileUpload} text="Carregar arquivo" padding="0.8rem 1.5rem"
                        onClick={importQuiz}/>
            </div>
